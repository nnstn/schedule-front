            ...
            <div class="tablebox1">
                ...
                <table class="bgtable">
                    ...
                    <tr v-for="(week,index) in theweek()" :index="index" :key="week">
                        <td v-for="(day,index) in week" :index="index" :key="day" v-bind:class="dayclass(day)">
                            {{day.date}}
                        </td>
                    </tr>
                    ...
                    <table class="scheduletable">
                        <tr v-for="(line,index) in row" :index="index" :key="line">
                            <td v-for="(td,index) in line" v-bind:colspan="td.colspan" :index="index" :key="td">
                                <div v-if="td.title"
                                     v-bind:class="['s',td.type,{'noleftradius':td.noleftradius,'norightradius':td.norightradius}]">
                                    {{td.title}}
                                </div>
                            </td>
                        </tr>
